...
let simpsonMembers = document.createElement('div');
simpsonMembers.classList.add('members');
document.body.appendChild(simpsonMembers);

for (const simpson of simpsons) {
    let simpsons1 = document.getElementsByClassName('members');
    let simpsonMember = document.createElement('div');
    simpsonMember.classList.add('member');
    simpsonMember.innerText = simpson.name + ' ' + simpson.surname;
    simpsons1[0].appendChild(simpsonMember);
}
...
for (const simpson of simpsons) {
    ...
    let simpsonMember = document.createElement('div');
    simpsonMember.style.marginTop = '10px';
    simpsonMember.classList.add('member');

    let simpsonName = document.createElement('div');
    simpsonName.innerText = simpson.name;
    let simpsonSurname = document.createElement('div');
    simpsonSurname.innerText = simpson.surname;
    let simpsonAge = document.createElement('div');
    simpsonAge.innerText = simpson.age;
    ...
    simpsons1[0].appendChild(simpsonMember);
    simpsonMember.append(simpsonName, simpsonSurname, simpsonAge, simpsonInfo, simpsonPhoto)
...
for (const coursesArrayElement of coursesArray) {
    ...
    let monthDur = document.createElement('div');
    monthDur.innerText = (` months duration: ${coursesArrayElement.monthDuration}`);
    let hourDur = document.createElement('div');
    hourDur.innerText = (`hours duration: ${coursesArrayElement.hourDuration}`);
    hourDur.style.marginLeft = '50px';
    ...
    for (const module of coursesArrayElement.modules) {
        ...
        modules.appendChild(liModule);
    }
    ;
    document.body.appendChild(coursesElement);
    coursesElement.append(title, duration, modules);
